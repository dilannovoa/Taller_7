...
insert INTO BaseDatos1.users_tbl (user_firstname, user_lastname, user_email, user_password)VALUES (UPPER('juan'), UPPER('lopez'), 'julopez@gmail.com',AES_ENCRYPT('password','$2a$15$Ov6xYXkMlR2Ez2/RwUiO.OoYBEIKcQzy3YQkIfeIQXCiTPUSAWPta'));
