...
import co.edu.sena.proyect_novoa.model.Product;

import co.edu.sena.proyect_novoa.model.repository.ProductRepositoryImpl;
...
public class ProductRegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        co.edu.sena.proyect_novoa.model.repository.Repository<Product> repository = new ProductRepositoryImpl();
        int rows = 0;
        try {
